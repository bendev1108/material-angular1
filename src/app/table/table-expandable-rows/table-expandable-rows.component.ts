...
export class TableExpandableRowsComponent {
  ...
  dataSourceExpandable = ELEMENT_DATA;
  columnsToDisplayExpandable = ['name', 'weight', 'symbol', 'position'];
  columnsToDisplayWithExpand = [...this.columnsToDisplayExpandable, 'expand'];
