...
export class TableBasicComponent {
  ...
  displayedColumnsBasic: string[] = ['position', 'name', 'weight', 'symbol'];
  dataSourceBasic = ELEMENT_DATA;
  ...
  dataSourceBasic1 = ELEMENT_DATA;
  displayedColumnsBasic1 = this.columns.map(c => c.columnDef);
